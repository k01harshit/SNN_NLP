...
Original file is located at
    https://colab.research.google.com/drive/176BsAcRE_1CUJsNgcRboajnqo5pHG6Eg
"""

# ==============================================================================
# NLP-SNN BENCHMARKING FUNCTIONS (v7.1 - Early Stopping Added)
# ==============================================================================
...
def train_benchmark(dataset_name, encoder_name, snn_epochs=25, patience=5):
    log("==================================================================")
    ...
    # 4. SNN
    log(f"[SNN] Info: Running 1-SADP with Early Stopping (Patience={patience})")
    ...
    log(f"[SNN] Starting SNN Training Loop (Max {snn_epochs} Epochs)...")
    ...
    for ep in range(snn_epochs):
        ...
        if train_acc > best_acc:
            ...
            wait += 1
            if wait >= patience:
                log(f"[SNN] Early stopping triggered! (No improvement for {patience} epochs)")
                break
